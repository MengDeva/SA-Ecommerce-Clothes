                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            @auth()
                                <ul>
                                    <li><i class="-firs-user"></i> {{ Auth::user()->name }} /
                        ...
                        <div class="header-nav d-none d-lg-flex">
                            <div class="main-categori-wrap d-none d-lg-block">
                                <a class="categori-button-active" href="{{ route('shop') }}">
                                    <span class="fi-rs-apps"></span> Welcome To Our Shop
                                </a>
                            </div>
                            ...
                            <div class="hotline d-none d-lg-block">
                                <p><i class="fi-rs-smartphone"></i><span>Phone Number</span> (+855) 99 767 231 </p>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="widget-about font-md mb-md-5 mb-lg-0">
                                    ...
                                    <p class="wow fadeIn animated">
                                        <strong>Address: </strong>360 Phnom Penh
                                    </p>
                                    <p class="wow fadeIn animated">
                                        <strong>Phone: </strong>+855 99 767 231
                                    </p>
                                    <p class="wow fadeIn animated">
                                        <strong>Email: </strong>contact@ss12clothesshop.in
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <p class="text-lg-end text-start font-sm text-muted mb-0">
                                &copy; <strong class="text-brand">SS12Clothes-Shop</strong> All rights reserved
                            </p>
                        </div>
                    </div>
                </div>
