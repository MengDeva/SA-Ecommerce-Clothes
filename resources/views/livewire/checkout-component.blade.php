                ...
                <form wire:submit.prevent="placeOrder">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @enderror
                            <div class="form-group">
                                <input type="text" name="billing_address1" placeholder="Address line1"
                                    wire:model="line1">
                            </div>
                            @error('line1')
                                <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="chek-form">
                                        <div class="custome-checkbox">
                                            ...
                                            <label class="form-check-label label_info" data-bs-toggle="collapse"
                                                ...
                                                aria-controls="collapseAddress" for="differentaddress"
                                                wire:model="ship_to_different"><span>Ship to a different
                                                    address?</span></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if (Session::has('checkout'))
                                <tr>
                                    ...
                                    <td class="product-subtotal" colspan="2">
                                        ${{ Session::get('checkout')['subtotal'] }}</td>
                                </tr>
                                <tr>
                                    <th>Tax</th>
                                    <td class="product-subtotal" colspan="2">
                                        ${{ Session::get('checkout')['tax'] }}</td>
                                </tr>
                                <tr>
                                    <th>Shipping</th>
